...
const exportAssistant = function (profile) {
  ...
  client.preview.understand
    ...
    function exportAssistantSchema (assistant){
      ...
      async.series({
        fallbackActions : (callback) =>{
          assistantFallbackActions(assistant, callback);
        },
        initiationActions : (callback) =>{
          assistantInitiationActions(assistant, callback);
        },
        assistantCustomFieldTypes : (callback) =>{
          assistantCustomFieldTypes(assistant, callback);
        },
        assistantIntents : (callback) =>{
          assistantIntents(assistant, callback);
        }
      }, async (err, result) => {
        if(err){
    ...
    const assistantFallbackActions = (assistant, callback) => {
    ...
    const assistantInitiationActions = (assistant, callback) => {
    ...
    const assistantCustomFieldTypes = (assistant, callback) => {
    ...
    const assistantCustomFieldValues = (assistant, fieldType, callback) => {
    ...
    const assistantIntents = (assistant, callback) => {
    
      spinner.text = 'Exporting assitant Intents...'
          ...
          async.each(intents, (intent, cb) => {
            async.series({
              assistantIntentActions : (i_cb) => {
                assistantIntentActions(assistant, intent, i_cb);
              },
              assistantIntentSamples : (i_cb) => {
                assistantIntentSamples(assistant, intent, i_cb);
              },
              assistantIntentfieldTypes : (i_cb) => {
                assistantIntentfieldTypes(assistant, intent, i_cb);
              }
            }, (err, result) => {
              if(err){
    ...
    const assistantIntentActions = (assistant, intent, callback) => {
    ...
    const assistantIntentSamples = (assistant,intent, callback) => {
    ...
    const assistantIntentfieldTypes = (assistant,intent, callback) => {
