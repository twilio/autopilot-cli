...
const twillioInitSetUp = () => {
  inquirer.prompt([{
      ...
      let newProfileName = json_utility.read().length?answer.profile.trim():'default';
...
const _askCredential = (profileName) => {
    ...
    inquirer.prompt([
      ...
      json_utility.addProfile(profileName,valid_credential_object);
  });
}
